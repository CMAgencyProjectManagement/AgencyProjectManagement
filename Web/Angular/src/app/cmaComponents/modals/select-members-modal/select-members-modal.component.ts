...
@Component({
  ...
  templateUrl: './select-members-modal.component.html',
  styleUrls: ['./select-members-modal.component.scss']
})
export class SelectMembersModalComponent implements OnInit {
  confirmCallback: any;
  cancelCallback: any;
  closeCallback: any;
  title: string;
