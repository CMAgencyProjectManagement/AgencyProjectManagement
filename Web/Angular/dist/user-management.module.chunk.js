...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_modal_dialog__ = __webpack_require__("../../../../ngx-modal-dialog/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UpdateUserComponent = /** @class */ (function () {
    function UpdateUserComponent(userService, storeService, teamService, modalService, viewRef) {
        this.userService = userService;
        this.storeService = storeService;
        this.teamService = teamService;
    ...
    UpdateUserComponent.prototype.resetPassword = function (id) {
        var _this = this;
    ...
    // TODO study dialog
    UpdateUserComponent.prototype.openNewDialog = function () {
        this.modalService.openDialog(this.viewRef, {
            title: 'Some modal title',
            childComponent: __WEBPACK_IMPORTED_MODULE_5_ngx_modal_dialog__["c" /* SimpleModalComponent */],
            data: 'the message'
        });
    };
    UpdateUserComponent.prototype.handleUpdate = function () {
        ...
        if (confirm('Save change?')) {
            ...
            this.userService.updateUser(this.foundUser.id, formValue.phone, formValue.email, formValue.team, formValue.isActive).then(function (value) {
                ...
                var errors = reason.response.body.Data;
                for (var _i = 0, errors_1 = errors; _i < errors_1.length; _i++) {
                    var error = errors_1[_i];
                    var fieldName = error.key;
                    var errorMessage = error.message;
    ...
    UpdateUserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_user_service__["a" /* UserService */],
            ...
            __WEBPACK_IMPORTED_MODULE_5_ngx_modal_dialog__["b" /* ModalDialogService */],
