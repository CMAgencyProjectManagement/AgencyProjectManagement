...
var AddProjectComponent = /** @class */ (function () {
    function AddProjectComponent(projectService, router) {
    ...
    AddProjectComponent.prototype.ngOnInit = function () {
        this.ProjectForm = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormGroup */]({
            projectName: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            projectDescription: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            projectStartDate: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            projectDeadline: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
        });
    };
    AddProjectComponent.prototype.handleCreate = function () {
        ...
        if (this.ProjectForm.valid) {
            ...
            this.isLoading = true;
            console.debug('here');
            this.projectService.createProject(formValue.projectName, formValue.projectDescription, formValue.projectStartDate.formatted, formValue.projectDeadline.formatted).then(function (value) {
    ...
    AddProjectComponent.prototype.handleCreateError = function (errors) {
...
var ProjectDetailComponent = /** @class */ (function () {
    ...
    ProjectDetailComponent.prototype.ngOnInit = function () {
        ...
        this.viewForm = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormGroup */]({
            projectname: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            customername: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            description: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            createdTime: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            startDate: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            deadline: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            changedBy: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
            changedTime: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */](undefined, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required),
        });
    };
    ...
    ProjectDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_project_service__["a" /* ProjectService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* Router */]])
...
module.exports = "<div class=\"animated fadeIn\" #gantt_here style='width: 100%; height: 100%;'></div>\r\n"
...
var ProjectTaskComponent = /** @class */ (function () {
    function ProjectTaskComponent(projectService, router) {
        this.projectService = projectService;
        this.router = router;
    }
    ...
    ProjectTaskComponent.prototype.GetURLParameter = function (sParam) {
        var sPageURL = window.location.href;
        var sURLVariables = sPageURL.split('?');
        var sUsername = sURLVariables[1].split('=');
        return sUsername[1];
...
var ProjectUpdateComponent = /** @class */ (function () {
    function ProjectUpdateComponent(projectService, router, pagerService) {
        this.projectService = projectService;
        this.router = router;
    ...
    ProjectUpdateComponent.prototype.GetURLParameter = function (sParam) {
        var sPageURL = window.location.href;
        var sURLVariables = sPageURL.split('?');
        var sUsername = sURLVariables[1].split('=');
        return sUsername[1];
    ...
    ProjectUpdateComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_project_service__["a" /* ProjectService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* Router */], __WEBPACK_IMPORTED_MODULE_2__services_pager_service__["a" /* PagerService */]])
